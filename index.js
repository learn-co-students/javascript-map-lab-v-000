...
const sortedRobots = robots.map(function(bot) {if (knownDecepticons.includes(bot.name))
  {return Object.assign({}, bot, {alliance: 'decepticon'}) }
else  {return Object.assign({}, bot, {alliance: 'autobot'})}
})
...
else  {return Object.assign({}, zebra, {color: 'white'})}
})
